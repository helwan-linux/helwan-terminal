...
INSTALL / تثبيت / INSTALAR / 安装
  install PACKAGE / تثبيت PACKAGE / instalar PACKAGE / 安装 PACKAGE

REMOVE / حذف / ELIMINAR / 删除
  remove PACKAGE / حذف PACKAGE / eliminar PACKAGE / 删除 PACKAGE

SEARCH / بحث / BUSCAR / 搜索
  search PACKAGE / بحث PACKAGE / buscar PACKAGE / 搜索 PACKAGE

SEARCH LOCAL / بحث محلي / BUSCAR LOCAL / 本地搜索
  search_local PACKAGE / بحث_محلي PACKAGE / buscar_local PACKAGE / 本地搜索 PACKAGE

PACKAGE INFO / معلومات الحزمة / INFO PAQUETE / 软件包信息
  pkg_info PACKAGE / معلومات_الحزمة PACKAGE / info_paquete PACKAGE / 软件包信息 PACKAGE

LOCAL INSTALL / تثبيت محلي / INSTALAR LOCAL / 本地安装
  local_install FILE / تثبيت_محلي FILE / instalar_local FILE / 本地安装 FILE

CLEAR CACHE / تنظيف الكاش / LIMPIAR CACHÉ / 清理缓存
  clr_cache / تفريغ_التخزين_المؤقت / limpiar_caché / 清理缓存

UNLOCK / فك القفل / DESBLOQUEAR / 解锁
  unlock / فك_القفل / desbloquear / 解锁

AUTOREMOVE / تنظيف المخلفات / LIMPIAR AUTOMÁTICO / 自动清理
  autoremove / تنظيف_المخلفات / limpiar_automatico / 自动清理
...
# ==========================================
# ربط الأسماء والأوامر بلغة آمنة تماماً ودون تضارب
# ==========================================
...
# 16. السجل (تم استخدام اسم آمن لتفادي تداخل الـ builtin history)
history_list() { helwan_history; }
سجل() { helwan_history; }
historial() { helwan_history; }
历史() { helwan_history; }

# 17. مسح الشاشة (تم استخدام اسم آمن لتفادي تداخل الـ builtin clear)
